...
const reviews = [
  ...
  },
  {
    ...
    date: "2021-07-23",
    title: "terrible!!!!!!",
    comment: "Not good at all!! Most of the code in the book is not working",
    rating: 1,
    courseId: "book-08",
  },
  {
  ...
  },
  {
    ...
    title: "Amazing read",
    comment:
      "The book was absolutely how I have had heard about it. This was one of those books which made me restless until I finished the book.",
    rating: 5,
    courseId: "book-21",
  },
  {
    ...
    title: "Amazing book",
    comment:
      "It's an absolute masterpiece. I know there have also been very critical comments on this books. But this book was a great one for me.",
    rating: 5,
    courseId: "book-21",
  },
  {
    ...
    title: "Interesting",
    comment:
      "Overall it is interesting to read. But didn't understand why he choose to write fiction.",
    rating: 5,
    courseId: "book-22",
  },
  {
  ...
  },
  {
    ...
    title: "Good",
    comment:
      "Its came with a really nice quality and this one of my fav book series as I am from India",
    rating: 5,
    courseId: "book-22",
  },
  {
    ...
    comment:
      "In love with the masterpieces created by Amish. If you are thinking of starting reading books, and don't know from where to start.",
    rating: 5,
    courseId: "book-23",
  },
  {
    ...
    title: "Read it",
    comment:
      "Its a good book to read. The trilogy is beautifully narrated. All the events seem real. You will just fall in love with the characters.",
    rating: 5,
    courseId: "book-23",
  },
  {
